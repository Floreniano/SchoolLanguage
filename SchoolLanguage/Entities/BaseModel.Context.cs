...
namespace SchoolLanguage.Entities
{
    using System;
    ...
    {
        private static LanguageSchoolEntities context;

        public static LanguageSchoolEntities GetContext()
        {
            if(context == null)
            {
                context = new LanguageSchoolEntities();
            }
            return context;
        }
